...
>>>>>>> ea1cdb35c9b626705a5f574a1316eb57de6cb187
    <div class="grid">
        <x-primary-button>
        ...
        <div class="flex flex-rows dark:text-gray-200 relative" x-show="open">
            @if (count($message) > 0)
                            ...
                            @forelse ($message as $index=> $item)
                                <tr class="border-b border-gray-400">
                                    ...
                                    <td class="items-center flex flex-rows-1 ">
                                        <button class="text-xl ml-3 w-10 h-5 rounded-xl"
                                        ...
                                        <button class="text-xl ml-4 rounded-full"
