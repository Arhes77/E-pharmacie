        ...
        <div class="flex flex-row  flex-wrap m-3">
            <div class="lg:w-2.5/3 md:w-1/2 px-1 border-r-2">
                <p class="w-fit text-justify">
                    ...
                    besoins en matière de santé et de bien-être.

                    Chez Epharm@237, nous comprenons que votre santé est votre priorité absolue, c'est pourquoi nous nous
                    ...
                    nous avons tout ce dont vous avez besoin, directement livré à votre porte.

                    Nous comprenons également l'importance de la confidentialité lorsqu'il s'agit de vos informations
                    ...
                    commande, n'hésitez pas à nous contacter. Nous sommes là pour vous fournir un service clientèle
                    exceptionnel et répondre à toutes vos préoccupations.
