...
@section('main')
    <div id="app" class=" flex flex-col font-bold decoration-4 items-center">
        ...
        <div class="flex flex-row-2 w-fit mx-5 my-3">
            <div class="bg-cover overflow-y-scroll h-96 w-1/2 rounded-md items-center mx-auto py-8 text-left"
                style="background-image: url('/images/cover/fond.jpg')">
                <div class="mx-1.5 my-1.5 ">
                    <h1 class="text-blue-600 text-4xl">Conseils</h1>
                    <ol class="mt-4">
                        <div class="mx-3">
                            <li><a href="#"> Comment bien choisir son soin minceur </a></li>
                            <li><a href="#"> Comment bien choisir son soin minceur </a></li>
                            <li><a href="#"> Comment bien choisir son soin minceur </a></li>
                            <li><a href="#"> Comment bien choisir son soin minceur </a></li>
                        </div>
            ...
            <div class="ml-5 mx-5 rounded-md h-full overflow-y-scroll  bg-slate-200 w-1/2">
                <div class="mx-1.5 my-1.5  py-8 h-1/2 ">
                ...
                <div class="bg-orange-500 h-1/2 mt-2.5 rounded-b-md text-white w-full bg-center flex flex-col">
                    <a href="#"class="flex m-2 hover:opacity-70   items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 hover:animate-ping mr-4 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                        </svg>
                        <h6 >Aller au Forum </h6>
                    </a>
                    <a href="mailto:willypericlesfoumeouamba@gmail.com" class="flex hover:opacity-70  m-2 items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 mr-4 hover:animate-bounce h-10">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        </svg>
                        <h6 >Envoyer nous un mail </h6>
                    </a>
                    <a href="tel:+237 6 52 10 05 06" class="flex m-2 hover:opacity-70 items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 hover:animate-spin mr-4 h-9">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="container  w-fit mx-5 my-3 items-center">
            <p class="">
                ...
                le
                prix de vos médicaments qui vous seront ensuite livrés. Chez Pharma237-online, nous avons mis en place un
            ...
            <p> <i class="text-xl my-2">L’expertise d’une équipe de pharmaciens à votre service</i><br>
                ...
                médicaments, la pharmacie contemporaine doit répondre à de nouvelles attentes et vous garantir un service
                irréprochable. Accessible 24h/24 et 7J/7, la pharmacie en ligne vous permet de commander vos médicaments et
        ...
        <div class="container  w-fit mx-5 my-3 items-center">
            <h3 class="text-2xl my-2 text-green-500">Une pharmacie en ligne qui vous permet un large choix de médicaments
                pour toute la famille</h3>
            <i class="text-xl my-2">L’expertise d’une équipe de pharmaciens à votre service</i><br>
            <p>En vous rendant sur notre site, vous avez en effet accès à un choix large de produits de pharmacie en stock,
                avec plus de 15 000 références disponibles des marques les plus connues et plus recherchées en pharmacie. De
                très nombreux médicaments sans ordonnance, en stock et en libre accès dits OTC (Over the Counter) sont
                proposés à l’achat sur le site. Ainsi, acheter en ligne des médicaments pour soigner un rhume, une rhinite,
                un rhume des foins, soulager des maux de tête, maux de gorge, toux, symptômes ORL, poussée d’herpès (bouton
            ...
            <p>Accessible où que vous soyez, LaSante.net référence de nombreux laboratoires tels que Pfizer, Bayer, Sanofi,
                Pierre Fabre, … pour vous proposer en stock tous les jours des médicaments de qualité, avec des procédés de
                fabrication pharmaceutiques contrôlés et une traçabilité des produits constante. Notre pharmacie en ligne
                s’engage depuis des années pour proposer une large sélection en stock de substituts nicotiniques pour vous
        ...
        <div class="container  w-fit mx-5 my-3 items-center">
            <h3 class="text-2xl my-2 text-green-500">Les plus grandes marques de parapharmacie, matériel médical, produits
                vétérinaires en ligne</h3>
            <i class="text-xl my-2">Notre large choix de bas, chaussettes et collants de contention</i><br>
            <p>Notre pharmacie en ligne propose également un large choix de matériel médical : vous trouverez, en ligne sur
                notre site, un large choix de bas, chaussettes ou collants de contention pour soulager les jambes lourdes
                avec notamment les produits de la marque Sigvaris, spécialisée dans la prise en charge des troubles de la
                circulation veineuse. Différents soins de parapharmacie pourront compléter vos achats en ligne pour
                retrouver des jambes légères. Une large gamme d’orthopédie avec de nombreuses orthèses est aussi proposée
                pour prévenir et soulager les douleurs articulaires ou douleurs musculaires liées à des pathologies précises
        ...
        <div class="container  w-fit mx-5 my-3 items-center">
            ...
            <p>Nous avons à cœur de satisfaire toutes les demandes adaptées à tous les âges. Les jeunes parents trouveront
                ...
                votre priorité, elle est aussi la nôtre. Notre pharma en ligne référence au meilleur prix un large choix de
                marques pour que vous trouviez le soin adapté à la peau votre bébé ou votre enfant : protection solaire en
                spray ou crème, soin pour les cheveux, soin pour la peau sèche de bébé, retrouvez vos produits préférés au
                ...
                catégorie Minceur, les séniors des produits pour favoriser le sommeil, antirides et anti-ronflements. Les
            ...
            <p>Nous avons ainsi sélectionné des laboratoires de qualité pour vous proposer un large choix de produits et
                compléments alimentaires pharma pour fortifier vos défenses immunitaires, améliorer votre confort urinaire
                ...
                soulager les douleurs articulaires ou les troubles de la circulation veineuse, notre équipe se met à votre
                ...
                choix à domicile, sur votre lieu de travail ou une livraison dans un point relais que vous aurez déterminé.
                Nous assurons un lien et une communication permanente avec les clients de notre pharmacie, par téléphone ou
                par mail pour des questions de Santé, de suivi de commande, de SAV ou pour toute question relative à l’un de
                nos produits ou l’utilisation des soins. Notre priorité, sécuriser vos commandes et vous conseiller
                Confidentialité et sécurité des délivrances Nos pharmaciens contrôlent les commandes de médicaments en ligne
                ...
                médicaments qui pourraient survenir avec les éléments fournis dans le profil médical. Nous vous garantissons
                une sécurisation des données médicales que vous nous confiez et le respect du secret médical qui vous est
                ...
                actualités médicales et pharmaceutiques. Ils vous renseignent également des dernières nouveautés et soins
                coup de cœur parapharmacie. Votre Santé, notre priorité Votre Santé exige un niveau d’excellence que nous
            ...
            <p class="text-blue-800">Filorga - Doliprane - Nurofen - Bioderma - Boiron - La Roche Posay - Vichy - Nicopass
        ...
        <div class="container  w-fit mx-5 my-3 items-center">
            ...
            <p>Pendant longtemps, les autorités sanitaires ont rappelé qu’il était dangereux d’acheter des médicaments en
                ligne. Les médicaments contrefaits et le manque total de traçabilité des produits trouvés en ligne ne sont
                pas des chimères. Il existe, encore aujourd’hui, des sites (en français) obscurs qui délivrent des
                médicaments (parfois soumis à une prescription médicale). LaSante.net est une pharmacie en lignée créée en
                2012 dès l’autorisation de vente en ligne de médicament pour une pharmacie française. Pionnière du secteur,
                nous affichons sur le site les seuls vrais moyens de rassurer nos clients qu’ils se trouvent bien sur le
                prolongement digital d’une pharmacie d’officine physique. LaSante.net a reçu tous les agréments nécessaires
                à son activité.
            </p>
            <i class="text-xl my-2">Comment reconnaître une pharmacie en ligne autorisée à vendre des médicaments en ligne
                ?</i><br>
            <p>Pour acheter vos médicaments en toute confiance, il faut en effet s’assurer que vous trouvez bien le logo et
                le lien qui redirige vers le Conseil de l’Ordre des Pharmaciens. Ce site d’autorité référence bien le site
                LaSante.net comme autorisé à la vente en ligne de médicament. Le logo du Conseil de l’Ordre des Pharmaciens
